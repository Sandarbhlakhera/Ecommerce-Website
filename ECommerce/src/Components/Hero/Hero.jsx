...
const ImageList=[
    {
        ...
        description: 
        'Lorem ipsum dolor sit amet consectetur adipisicing elit. Eum sequi eius praesentium labore laborum distinctio minus non nihil ex iusto nobis, aliquam reiciendis saepe earum voluptatibus fuga, tempore nostrum! Magnam.',
    },
    {
        id:2,
        img: Image2,
                ...
                <div>
                    <div className='grid grid-cols-1 sm:grid-cols-2'>
                        <div className='flex flex-col justify-center gap-4 pt-12 sm:pt-0 text-center sm:text-left order-2 sm:order-1 relative z-10'>
                            ...
                            data-aos-duration='500' data-aos-once='true' className='text-5xl sm:text-6xl lg:text-7xl font-bold'>{data.title}</h1>
                            <p
                            data-aos='fade-up'
