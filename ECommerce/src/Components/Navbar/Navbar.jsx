...
const Navbar = ({handleOrderPopup}) => {
  return (
    ...
    <div data-aos='zoom-in' className='sm:flex hidden items-center'>
        <ul className='sm:flex hidden items-center gap-4'>
            ...
            <li className='group relative cursor-pointer'>
                <a href='#' className='flex items-center gap-[2px] py-2'>Trending Products
                    ...
                    <div className='absoulte z-[9999] hidden group-hover:block w-[200px] rounded-md bg-white p-2 text-black shadow-md'> 
                        <ul>
