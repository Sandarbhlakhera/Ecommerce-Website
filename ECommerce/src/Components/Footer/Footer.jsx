        ...
        <div className='container'>
            <div data-aos='zoom-in' className='grid md:grid-cols-3 pb-44 pt-5'>
                <div className='py-8 px-4'>
                    ...
                    <p> Lorem ipsum dolor sit, amet consectetur adipisicing elit. Perspiciatis nihil fuga nesciunt doloremque fugit laborum omnis? Vero itaque aperiam culpa magni molestiae placeat saepe odio, ducimus veniam? Accusantium, accusamus magnam!</p>
                </div>
                <div className='py-8 px-4'>
            ...
            <div className='py-8 px-4'>
                ...
                <ul className='flex flex-col gap-3'>
                        {FooterLinks.map((link)=>(
                            <li className='cursor-pointer hover:text-primary hover:translate-x-1 duration-300 text-gray-200' key={link.title}></li>
                        ))}
                </ul>
            </div>
            </div>
